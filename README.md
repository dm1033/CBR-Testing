# TWC Rapid CBR — Field Kit for Contractors
...
| Pack | Price (ex VAT) |
|---|---|
| Field Kit — TRL-pattern DCP + method + GroundCheck | **£1,495** |
| Methodology only (if you already own a DCP) | £249 |
| Site test visit (four outrigger positions) | from £280 |

Hardware is a UK **TRL-pattern Dynamic Cone Penetrometer** in the [Impact Test SL970](https://www.impact-test.co.uk/products/3147-dynamic-cone-penetrometer/) class: 8 kg hammer, 575 mm drop, 20 mm 60° cone, transit case, spare cone.
